...
export default function UsersContextProvider({ children }) {
    ...
    useEffect(() => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/calendarEvent/${signinUser}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    const addEvent = (newEvent) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/calendarEvent/add/${signinUser}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/add/${signinUser}`;
    ...
    const handleCalendarDelete = (event) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/calendarEvent/delete/${signinUser}/${event.title}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/delete/${signinUser}/${event.title}`;
        axios.delete(URL)
            .then(res => {
    ...
    const handleCalendarSaveEdit = (editedEvent) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/calendarEvent/edit/${signinUser}/${editEvent.title}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/edit/${signinUser}/${editEvent.title}`;
    ...
    useEffect(() => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/todo/${signinUser}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    function handleUpdateTodo(event) {
        ...
        if (mode === "edit") {
            ...
            setMode("create");
            setTodo({});
            const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/todo/edit/${signinUser}/${todo.title}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/edit/${signinUser}/${todo.title}`;
    ...
    function handleDeleteTodo(title = "") {
        ...
        setTodos(matchedData);
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/todo/delete/${signinUser}/${title}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/delete/${signinUser}/${title}`;
        axios.delete(URL)
            .then(res => {
    ...
    useEffect(() => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/contacts/${signinUser}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    const addContact = (newContact) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/contacts/add/${signinUser}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/add/${signinUser}`;
    ...
    const handleContactsDelete = (contact) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/contacts/delete/${signinUser}/${contact.name}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/delete/${signinUser}/${contact.name}`;
        axios.delete(URL)
            .then(res => {
    ...
    const handleContactsSaveEdit = (editedContact) => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/contacts/edit/${signinUser}/${editedContact.name}` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/edit/${signinUser}/${editedContact.name}`;
    ...
    useEffect(() => {
        const URL = process.env.NODE_ENV === 'development' ? `${process.env.REACT_APP_DEV_URL_FOR_BACKEND}/festival/get` : `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/festival/get`;
        axios.get(URL)
            .then(res => {
